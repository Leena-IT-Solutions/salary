...
Route::middleware(['auth', 'role'])->group(function () {
    ...
    ************************************/
    ...
    Route::get('/payslip/single/{id}', [App\Http\Controllers\PayslipController::class, 'single_payslip']);
    Route::get('/payslip/history/{employee_id}', [App\Http\Controllers\PayslipController::class, 'fetch_history']);
    Route::post('/payroll/send_email', [App\Http\Controllers\PayslipController::class, 'send_email']);
    ...
    ************************************/
    ...
    Route::group(['prefix' => 'employee'], function () {
        ...
        Route::get('/profile', [App\Http\Controllers\Employee\EmployeeDashboardController::class, 'profile']);
        Route::get('/payslips', [App\Http\Controllers\Employee\EmployeeDashboardController::class, 'payslips']);
        Route::get('/attendance', [App\Http\Controllers\Employee\EmployeeDashboardController::class, 'attendance'])->name('employee.attendance');
        Route::get('/holidays', [App\Http\Controllers\Employee\EmployeeDashboardController::class, 'holidays'])->name('employee.holidays');
        Route::get('/dashboard/get_my_data', [App\Http\Controllers\Employee\EmployeeDashboardController::class, 'get_my_data']);
        Route::get('/requests', [App\Http\Controllers\Employee\EmployeeDashboardController::class, 'requests']);
        Route::get('/dashboard/get_payslip_details/{id}', [App\Http\Controllers\Employee\EmployeeDashboardController::class, 'get_payslip_details']);
    });
    ...
    ************************************/
    ...
    Route::post('/employee/employee_manager/export/canva_excel', [App\Http\Controllers\EmployeeController::class, 'exportCanvaExcel'])->name('employee.export.canva_excel');
    ...
    ************************************/
    ...
    /* Pending Approval */
    Route::get('/approvals/pending', [App\Http\Controllers\PendingApprovalController::class, 'index'])->name('approvals.pending');
    Route::get('/approvals/pending/fetch', [App\Http\Controllers\PendingApprovalController::class, 'fetch'])->name('approvals.pending.fetch');
    Route::post('/approvals/pending/updateStatus', [App\Http\Controllers\PendingApprovalController::class, 'updateStatus'])->name('approvals.pending.updateStatus');
