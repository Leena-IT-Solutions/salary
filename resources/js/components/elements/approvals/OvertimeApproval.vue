        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-xl-4">
                <div v-if="employee" class="profile-card-modern shadow-sm sticky-top" style="top: 20px;">
                    ...
                    <div class="p-4 pt-0">
                        <div class="alert alert-warning border-0 rounded-4 small mb-0">
                            ...
                            Ensure overtime hours are verified against attendance logs before approval.
                        </div>
                    </div>
                </div>
                ...
                <div v-else class="empty-state-card text-center p-5 shadow-sm bg-white rounded-4 border-dashed">
                    ...
                    <p class="mt-3 text-muted">Enter employee code to manage overtime entries.</p>
                </div>
            </div>
                ...
                <div v-if="(item && employee) || item.id != null" class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                        <h5 class="fw-bold mb-0">
                            {{ item.id ? 'Modify Overtime' : 'New Overtime Entry' }}
                        </h5>
                    ...
                    <div class="card-body p-4">
                        <div class="row g-4">
                            <forms-date-field name="on_date" label="Overtime Date" v-model="item.on_date" :error="errors.on_date" classes="col-12 col-lg-4"></forms-date-field>
                            <forms-number-field name="hrs" label="Total Hours" v-model="item.hrs" :error="errors.hrs" classes="col-12 col-lg-4"></forms-number-field>
                            ...
                            <forms-text-field name="note" label="Manager Notes / Reason" v-model="item.note" :error="errors.note" classes="col-12"></forms-text-field>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                            ...
                            <forms-submit-button name="" v-model="loading" label="Save Overtime" @click="save()" classes="btn-lg px-5"></forms-submit-button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-header bg-white border-0 py-3">
                        <div class="row align-items-center">
                            <div class="col text-start">
                                <h5 class="fw-bold mb-0">Overtime History</h5>
                            </div>
                            <div class="col-auto">
                            ...
                            <tbody>
                                <tr v-for="row in items" :key="row.id" class="cursor-pointer" @click="edit(row)">
                                    ...
                                    <td class="text-center">
                                        <span class="badge bg-light text-dark border px-2">{{ row.hrs }} Hrs</span>
                                    </td>
                                    <td class="text-center">
