<template>
    <div class="container-fluid">
        ...
        <div  v-if="(item && employee) || item.id != null" class="row g-4 mb-5">
            ...
            <forms-date-field name="from_date" label="From Date" v-model="item.from_date" error="" classes="col-12 col-md-6"></forms-date-field>
            
            <forms-date-field name="to_date" label="To Date" v-model="item.to_date" error="" classes="col-12 col-md-6"></forms-date-field>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th @click="orderBy('from_date')" class="cursor-pointer">From Date</th>
                        <th @click="orderBy('to_date')" class="cursor-pointer">To Date</th>
