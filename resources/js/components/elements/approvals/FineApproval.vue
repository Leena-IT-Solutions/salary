<template>
    <div class="container-fluid">
        ...
        <div  v-if="item" class="row g-4 mb-5">
            ...
            <forms-date-field name="app_date" label="Date" v-model="item.app_date" error="" classes="col-12 col-lg-6"></forms-date-field>

            <forms-text-field name="amount" label="Amount" v-model="item.amount" error="" classes="col-12 col-lg-6"></forms-text-field>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th @click="orderBy('note')" class="cursor-pointer">Reason</th>
...
export default {
    ...
    methods: {
        ...
        add(){
            this.loading = true;
            axios.post('/approvals/fine/add', this.item).then(res => {
                this.reset();
                this.search();
            });
        },
        ...
        update(){
            this.loading = true;
            axios.post('/approvals/fine/update', this.item).then(res => {
                this.reset();
                this.search();
            });
        },
