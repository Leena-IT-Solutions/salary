<template>
    <div class="container-fluid">
        ...
        <div  v-if="item" class="row g-4 mb-5">
            ...
            <forms-select-field name="reimbursement_component_id" label="Reimbursement" v-model="item.reimbursement_component_id" error="" classes="col-12 col-lg-3" 
            ...
            <forms-text-field name="amount" label="Amount" v-model="item.amount" error="" classes="col-12 col-lg-3"></forms-text-field>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="cursor-pointer">Reimbursement Head</th>
                ...
                <tbody>
                    <tr v-for="row in items" :key="row.id">
                        ...
                        <td>{{ row.app_date }}</td>
                        <td>{{ row.reimbursement_component.name }}</td>
                        <td>{{ row.amount }}/-</td>
                        <td>{{ row.status }}</td>
                        <td class="text-end">
...
export default {
    ...
    methods: {
        ...
        edit(item){
            ...
            this.item.reimbursement_component_id = item.reimbursement_component_id;
