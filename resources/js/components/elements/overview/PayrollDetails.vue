            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-premium border-0 rounded-xl mt-2">
                        ...
                        <li><a class="dropdown-item py-2" :href="'/pdf/total_payout_cheque/'+payroll.id" target="_blank"><i class="bi bi-cash-stack me-2 text-primary"></i>Total Net Payout Cheque (PDF)</a></li>
